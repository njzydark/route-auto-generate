...
// 根据获取的页面文件地址输出路由代码
function filesToRoutes(files, routePrefix, pagesPath, pagesAlias, framework, coverRoutes, redirectPath, chunkNamePrefix, template) {
  files = [...files].sort();
  ...
  if (redirectPath) {
    routes.push(template.routeTpl('redirectPath', redirectPath))
  }
