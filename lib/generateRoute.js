...
// 根据获取的页面文件地址输出路由代码
function filesToRoutes(files, routePrefix, pagesPath, pagesAlias, framework, coverRoutes, notFoundRoute, chunkNamePrefix, template) {
  files = [...files].sort();
  ...
  if (notFoundRoute) {
    routes.push(template.routeTpl('noFoundPage', '*', notFoundRoute, 'pages'))
  }
